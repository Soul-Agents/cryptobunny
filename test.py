...
print(
    f"API_SECRET_KEY: {API_SECRET_KEY[:4]}...{API_SECRET_KEY[-4:] if API_SECRET_KEY else 'None'}"
)
print(
    f"ACCESS_TOKEN: {ACCESS_TOKEN[:4]}...{ACCESS_TOKEN[-4:] if ACCESS_TOKEN else 'None'}"
)
print(
    f"ACCESS_TOKEN_SECRET: {ACCESS_TOKEN_SECRET[:4]}...{ACCESS_TOKEN_SECRET[-4:] if ACCESS_TOKEN_SECRET else 'None'}"
)
